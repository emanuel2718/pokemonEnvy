...
import Game.Entities.Statics.CaveGuardian;
...
public class WorldManager {
	...
	private int xPos;
	private int yPos;
	String alphabet1 = " abcdefghijklmnopqrstuvwxyzabcd"; // easter
	...
	public WorldManager(Handler handler, EntityManager entityManager) {
		...
		this.entityManager.AddEntity(handler.newEnemy(Images.PEnemyIdleTrainer,handler,500, 800,"MapState","Common Trainer","None","EnemyOne",100,25,40,1,8,12,20,10,20,10,1,5,"None","Fire",null,null)); // lvl 0 dificulty
		this.entityManager.AddEntity(handler.newEnemy(Images.PEnemyIdleTrainer,handler,1400, 600,"MapState","Common Trainer","None","EnemyOne",100,25,40,1,8,12,20,10,20,10,1,5,"None","Fire",null,null)); // lvl 0 dificulty
		this.entityManager.AddEntity(new CaveGuardian(handler, 1630, 60)); // Adds the cave guardian entity.
	...
	/*
	 * Spawn the quest target monster only when the quest has been accepted.
	 */
	public void spawnQuestTarget() {
		if (BaseNPC.questStarted) {
			this.entityManager.AddEntity(handler.newEnemy(Images.PEnemyIdleBrook,handler,2400, -200,"MapState","Brock","None","EnemyOne",100,25,40,1,8,12,20,10,20,10,1,5,"None","Fire",null,null)); // lvl 0 dificulty
		}
	}
	...
	public void tick() {
		...
		/*
		 * Add Debug key that turns on and off Debug mode in the world.
		 */
	...
	private void AddWalls() {
		...
		// Wall of the Cave Guardian.
        worldWalls.add(new Walls(handler, 1620, 95, 125, 90, "Cave Obstacle Wall"));
        worldWalls.add(new Walls(handler, 1790, 105, 100, 75, "Woke Snorlax Wall"));
		...
		worldWalls.add(new Walls(handler, 1100, 420, 180,225, "Door Town"));
