...
public class CaveArea extends BaseArea {
    ...
    public final static int playerCaveAreaXSpawn = -380, playerCaveAreaYSpawn = -3180
    		;
    ...
    public CaveArea(Handler handler, EntityManager entityManager) {
        ...
        name="Cave";
        handler.setXInWorldDisplacement(playerCaveAreaXSpawn);
        handler.setYInWorldDisplacement(playerCaveAreaYSpawn);
        ...
        this.entityManager.AddEntity(handler.newEnemy(Images.PEnemyIdleTrainer,handler,700, 2000,"InWorldState","Common Trainer","Cave","EnemyOne",150,25,80,1,8,12,20,10,20,10,1,10,"None","Thunder",null,null)); //lvl 2 difficulty
        this.entityManager.AddEntity(handler.newEnemy(Images.PEnemyIdleTrainer,handler,3000, 1000,"InWorldState","Common Trainer","Cave","EnemyOne",100,25,60,10,1,12,20,10,20,13,1,10,"None","Thunder",null,null)); // lvl 1 difficulty
