...
public class MenuState extends State {
	...
	public void render(Graphics g) {
		...
		g.drawImage(Images.title,this.xPos, this.yPos, this.width + 3, this.height, null);
		g.drawImage(Images.title,this.xPos2, this.yPos, this.width + 3, this.height, null);
		...
		g.drawImage(Images.titleImage, this.imageX - 250, this.yPos + 300, handler.getHeight() / 2, handler.getHeight() / 2, null);
