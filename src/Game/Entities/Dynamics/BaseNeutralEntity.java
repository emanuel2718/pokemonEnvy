...
/*
 * This class will be the base of every NPC in the game
 */
public class BaseNeutralEntity extends BaseDynamicEntity {
    ...
    public BaseNeutralEntity(Handler handler, int xPosition, int yPosition, String state,String name,String area, BufferedImage[] animFrames) {
