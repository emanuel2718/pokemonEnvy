...
public class Images {
	...
	public static BufferedImage caveGuardian;
	public static BufferedImage questStartedDialogBox;
	//public static BufferedImage questStartedDialogBox1;
	//public static BufferedImage questStartedDialogBox2;
	//public static BufferedImage questStartedDialogBox3;
	//public static BufferedImage questStartedDialogBox4;
	public static BufferedImage questCompletedDialogBox;
	public static BufferedImage arceuDialogBox;

	public static BufferedImage mewtwo_front;
	public static BufferedImage arceus;
	public static BufferedImage ethanPL;
	public static BufferedImage redPL;
	public static SpriteSheet mewtwoSheet;
	public static SpriteSheet arceusSheet;
	public static SpriteSheet ethanSheet;
	public static SpriteSheet redSheet;
	public static SpriteSheet playerSheet;
	public static SpriteSheet playerFightSheet;
	public static BufferedImage[] player_front;
	public static BufferedImage[] player_left;
	public static BufferedImage[] player_right;
	public static BufferedImage[] player_back;
	public static BufferedImage playerFighter;

	/*
	 * TODO: ORIGINAL PLAYER!!!!!!!!!!!!!
	 */
	//public static SpriteSheet playerSheet;
	//public static BufferedImage[] player_front;
	//public static BufferedImage[] player_left;
	...
	public static BufferedImage[] PEnemyIdleBrook;
	public static BufferedImage[] PEnemyIdleRed;
	public static BufferedImage[] PEnemyIdleEthan;
	public static BufferedImage[] PEnemyIdleTrainer;


	public static SpriteSheet PTrainerEnemySheet;
	public static SpriteSheet ethanAnimatedEnemySpriteSheet;
	...
	public static BufferedImage[] ThunderSkill;
	...
	public static SpriteSheet thunderSkillSheet;
	...
	public static BufferedImage StaticTownMap;
	public static BufferedImage insideTower;//inside tower
	public static BufferedImage PokemonLeagueMap;// Outside Pokemon League map
	public static BufferedImage PokemonLeagueFirstRoom;// Inside Pokemon League map; First Room
	public static BufferedImage PokemonLeagueSecondRoom;// Inside Pokemon League map; Final Room
	public static BufferedImage CaveMap;
	public static BufferedImage Loading;
	public static Image ScaledTown;
	public static Image StaticScaledTown;
	public static Image ScaledCave;
	public static Image ScaledArea;
	public static Image ScaledTower;
	public static Image ScaledPokemonLeagueArea;
	public static Image ScaledPokemonLeagueFirstRoom;
	public static Image ScaledPokemonLeagueSecondRoom;
	...
	public Images() {
		...
		ThunderSkill = new BufferedImage[24]; // Pikachu Thunder skill
		...
		PEnemyIdleBrook = new BufferedImage[6];
		PEnemyIdleRed = new BufferedImage[6];
		PEnemyIdleEthan = new BufferedImage[6];
		PEnemyIdleTrainer = new BufferedImage[6]; // Basic Trainer
		...
		try {
			...
			thunderSkillSheet = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/thunderSpriteSheet.png"))); // Thunder skill sprite sheet
			...
			ethanAnimatedEnemySpriteSheet = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/ethanAnimatedSpriteSheet.png")));
			PTrainerEnemySheet = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/animatedTrainersSpriteSheet.png")));
			PEnemySheet = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/animatedTrainersSpriteSheet.png")));
			...
			caveGuardian = ImageIO.read(getClass().getResourceAsStream("/Sheets/snorlaxGuardian.png"));
			questStartedDialogBox = ImageIO.read(getClass().getResourceAsStream("/Sheets/questStartedDialogBox.png"));
			//questStartedDialogBox1 = ImageIO.read(getClass().getResourceAsStream("/Sheets/questStartedDialogBox1.png"));
			//questStartedDialogBox2 = ImageIO.read(getClass().getResourceAsStream("/Sheets/questStartedDialogBox2.png"));
			//questStartedDialogBox3 = ImageIO.read(getClass().getResourceAsStream("/Sheets/questStartedDialogBox3.png"));
			//questStartedDialogBox4 = ImageIO.read(getClass().getResourceAsStream("/Sheets/questStartedDialogBox4.png"));
			questCompletedDialogBox = ImageIO.read(getClass().getResourceAsStream("/Sheets/questCompletedDialogBox.png"));
			arceuDialogBox = ImageIO.read(getClass().getResourceAsStream("/Sheets/arceusDialogueBox.png"));


			TownMap = ImageIO.read(getClass().getResourceAsStream("/Worlds/TownMap.png"));
			StaticTownMap = ImageIO.read(getClass().getResourceAsStream("/Worlds/StaticTownMap.png"));
			insideTower = ImageIO.read(getClass().getResourceAsStream("/Worlds/insideTower.png"));//InsideTower
			CaveMap = ImageIO.read(getClass().getResourceAsStream("/Worlds/CaveMap.png"));
			PokemonLeagueMap = ImageIO.read(getClass().getResourceAsStream("/Worlds/pokemonLeagueArea.png"));
			PokemonLeagueFirstRoom = ImageIO.read(getClass().getResourceAsStream("/Worlds/pokemonLeagueFirstRoom.png"));
			PokemonLeagueSecondRoom = ImageIO.read(getClass().getResourceAsStream("/Worlds/pokemonLeagueFinalRoom.png"));
			...
			battleBackground[4] = ImageIO.read(getClass().getResourceAsStream("/Sheets/PKMNLeagueBackground.png"));
			...
			// Draw Brock Enemy:
			PEnemyIdleBrook[0] = PTrainerEnemySheet.crop(214, 1205, 39, 67);
			PEnemyIdleBrook[1] = PTrainerEnemySheet.crop(264, 1205, 46, 63);
			PEnemyIdleBrook[2] = PTrainerEnemySheet.crop(330, 1205, 47, 54);
			PEnemyIdleBrook[3] = PTrainerEnemySheet.crop(330, 1205, 47, 54);
			PEnemyIdleBrook[4] = PTrainerEnemySheet.crop(264, 1205, 46, 63);
			PEnemyIdleBrook[5] = PTrainerEnemySheet.crop(214, 1205, 39, 67);

			// Draw Red Pokemon League Enemy:
			PEnemyIdleRed[0] = PTrainerEnemySheet.crop(178, 1407, 39, 73);
			PEnemyIdleRed[1] = PTrainerEnemySheet.crop(225, 1407, 39, 73);
			PEnemyIdleRed[2] = PTrainerEnemySheet.crop(269, 1407, 39, 73);
			PEnemyIdleRed[3] = PTrainerEnemySheet.crop(269, 1407, 39, 73);
			PEnemyIdleRed[4] = PTrainerEnemySheet.crop(225, 1407, 39, 73);
			PEnemyIdleRed[5] = PTrainerEnemySheet.crop(178, 1407, 39, 73);

			// Draw Ethan Pokemon League Enemy:
			PEnemyIdleEthan[0] = ethanAnimatedEnemySpriteSheet.crop(1, 4, 37, 71);
			PEnemyIdleEthan[1] = ethanAnimatedEnemySpriteSheet.crop(37, 2, 40, 72);
			PEnemyIdleEthan[2] = ethanAnimatedEnemySpriteSheet.crop(76, 1, 41, 74);
			PEnemyIdleEthan[3] = ethanAnimatedEnemySpriteSheet.crop(116, 5, 37, 70);
			PEnemyIdleEthan[4] = ethanAnimatedEnemySpriteSheet.crop(155, 7, 37, 68);
			PEnemyIdleEthan[5] = ethanAnimatedEnemySpriteSheet.crop(155, 7, 37, 68);

			//Draw basic Trainer Sprite
			PEnemyIdleTrainer[0] = PEnemySheet.crop(15, 1402, 48, 81);
			PEnemyIdleTrainer[1] = PEnemySheet.crop(65, 1402, 41, 78);
			PEnemyIdleTrainer[2] = PEnemySheet.crop(106, 1404, 56, 81);
			PEnemyIdleTrainer[3] = PEnemySheet.crop(106, 1404, 56, 81);
			PEnemyIdleTrainer[4] = PEnemySheet.crop(65, 1402, 41, 78);
			PEnemyIdleTrainer[5] = PEnemySheet.crop(15, 1402, 48, 81);


			playerFightSheet =  new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/PlayerSpriteSheet.png")));
			playerSheet =  new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/pikachuSpriteSheet.png")));
			mewtwoSheet = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/mew2Overworld.png")));
			arceusSheet = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/arceusOverWorld.png")));
			ethanSheet = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/ethanSpriteSheet.png")));
			redSheet = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/redSpriteSheet.png")));


			// Sprites of various NPC's
			mewtwo_front = mewtwoSheet.crop(65, 1386,27,31);
			arceus = arceusSheet.crop(79, 20,33,46);
			ethanPL = ethanSheet.crop(10, 9,41,52);
			redPL = redSheet.crop(12, 11,38,53);





			player_front[0] = playerSheet.crop(187, 24, 21, 28);
			player_front[1] = playerSheet.crop(220, 24, 24, 29);
			player_front[2] = playerSheet.crop(149, 24, 23, 27);
			player_front[3] = playerSheet.crop(220, 24, 24, 29);

			player_back[0] = playerSheet.crop(183, 53, 22, 27);
			player_back[1] = playerSheet.crop(220, 53, 23, 29);
			player_back[2] = playerSheet.crop(150, 55, 27, 27);
			player_back[3] = playerSheet.crop(183, 53, 22, 27);

			player_left[0] = playerSheet.crop(185, 85, 24, 27);
			player_left[1] = playerSheet.crop(220, 85, 24, 27);
			player_left[2] = playerSheet.crop(153, 88, 23, 24);
			player_left[3] = playerSheet.crop(185, 85, 24, 27);

			player_right[0] = playerSheet.crop(184, 118, 24, 27);
			player_right[1] = playerSheet.crop(218, 117, 24, 27);
			player_right[2] = playerSheet.crop(151, 119, 23, 24);
			player_right[3] = playerSheet.crop(184, 118, 24, 27);


			// Player attack animation.
			playerFighter = playerFightSheet.crop(472, 0, 40, 42);
			...
			// Pikachu Thunder skill:
			ThunderSkill[0] = thunderSkillSheet.crop( 23, 21, 147, 152);
			ThunderSkill[1] = thunderSkillSheet.crop( 210, 9, 154, 171);
			ThunderSkill[2] = thunderSkillSheet.crop( 403, 23, 154, 157);
			ThunderSkill[3] = thunderSkillSheet.crop( 600, 34, 144, 114);
			ThunderSkill[4] = thunderSkillSheet.crop( 787, 26, 143, 141);
			ThunderSkill[5] = thunderSkillSheet.crop( 17, 217, 163, 144);
			ThunderSkill[6] = thunderSkillSheet.crop( 17, 217, 163, 144);
			ThunderSkill[7] = thunderSkillSheet.crop( 787, 26, 143, 141);
			ThunderSkill[8] = thunderSkillSheet.crop( 600, 34, 144, 114);
			ThunderSkill[9] = thunderSkillSheet.crop( 403, 23, 154, 157);
			ThunderSkill[10] = thunderSkillSheet.crop( 210, 9, 154, 171);
			ThunderSkill[11] = thunderSkillSheet.crop( 23, 21, 147, 152);
			ThunderSkill[12] = thunderSkillSheet.crop( 23, 21, 147, 152);
			ThunderSkill[13] = thunderSkillSheet.crop( 210, 9, 154, 171);
			ThunderSkill[14] = thunderSkillSheet.crop( 403, 23, 154, 157);
			ThunderSkill[15] = thunderSkillSheet.crop( 600, 34, 144, 114);
			ThunderSkill[16] = thunderSkillSheet.crop( 787, 26, 143, 141);
			ThunderSkill[17] = thunderSkillSheet.crop( 17, 217, 163, 144);
			ThunderSkill[18] = thunderSkillSheet.crop( 17, 217, 163, 144);
			ThunderSkill[19] = thunderSkillSheet.crop( 787, 26, 143, 141);
			ThunderSkill[20] = thunderSkillSheet.crop( 600, 34, 144, 114);
			ThunderSkill[21] = thunderSkillSheet.crop( 403, 23, 154, 157);
			ThunderSkill[22] = thunderSkillSheet.crop( 210, 9, 154, 171);
			ThunderSkill[23] = thunderSkillSheet.crop( 23, 21, 147, 152);
		...
		// Map of the town.
		ScaledTown = Images.TownMap.getScaledInstance(3840, 3020, Image.SCALE_SMOOTH);// 384x302 pixel image
		StaticScaledTown = Images.StaticTownMap.getScaledInstance(3840, 3020, Image.SCALE_SMOOTH); // 384x302 pixel image
		ScaledTower = Images.insideTower.getScaledInstance(3620, 3750, Image.SCALE_SMOOTH);// 362x475 pixel image
		ScaledPokemonLeagueArea = Images.PokemonLeagueMap.getScaledInstance(3840, 3190, Image.SCALE_SMOOTH);// 384x319 pixel image
		ScaledPokemonLeagueFirstRoom = Images.PokemonLeagueFirstRoom.getScaledInstance(2080, 2030, Image.SCALE_SMOOTH);// 208x203 pixel image
		ScaledPokemonLeagueSecondRoom = Images.PokemonLeagueSecondRoom.getScaledInstance(2650, 4180, Image.SCALE_SMOOTH);// 265x418 pixel image
