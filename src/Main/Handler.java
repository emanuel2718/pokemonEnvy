 ...
 * 		remove the comments on the following two lines of code and comment out the height and width declaration in this method*/
	...
	// Create handler for Neutral Entities like an NPC.
	public BaseNeutralEntity newNPC(BufferedImage[] images,Handler handler, int xPosition, int yPosition, String name,
									String area, String state) {
		return new BaseNPC(handler, xPosition, yPosition,name, area, state,images);
